...
public class CalculationService {
    ...
    public BigDecimal calculationVocationPayWithHolidays(BigDecimal salary,String startDateParam, String endDateParam){
        ...
        return salary.divide(countDaysInMonth, RoundingMode.HALF_DOWN).multiply(BigDecimal.valueOf(countAllDays - countHoliday));
